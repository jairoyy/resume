...
function generateCV(){
    let q = document.getElementById("nameField").value;
    let w = document.getElementById("contactField").value;
    let r = document.getElementById("emailField").value;
    let t = document.getElementById("pfField").value;
    if(q == "" || w=="" || r=="" || t==""){
        alert('Check the mandatory fields');
    }
    else{
